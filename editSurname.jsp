...
<%
        ...
        String new_surname = request.getParameter("new_surname"); 
        
        PreparedStatement ps = conn.prepareStatement("UPDATE client SET surname = '"+new_surname+"' WHERE id = "+session.getAttribute("id_k"));
        ps.executeUpdate();  
        session.setAttribute("surname", new_surname); 
 ...
 <h1> Surname has been changed! </h2> 
        </div>
      </div>
